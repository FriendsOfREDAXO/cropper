...
<input type="hidden" id="dataImageBoxX" name="image_box_x">
<input type="hidden" id="dataImageBoxY" name="image_box_y">
<input type="hidden" id="dataImageBoxWidth" name="image_box_width">
<input type="hidden" id="dataImageBoxHeight" name="image_box_height">
